...
test("기억 신규와 덮어쓰기가 이전 값과 태그 변화까지 스레드에 붙는다", () => {
  ...
  assert.equal(
    ...
    [
      ...
      "",
      "～ *[사실 · 캐릭터] 생활/운동*",
      "> 이전: 주 이삼 회 집 근처를 달린다. 바쁘면 건너뛴다 (생성 때 값)",
      "> 새 값: 요즘은 아침마다 달린다",
      "> 태그: 생활 · 운동",
      "> 관심 수준: 보통",
      "",
...
test("관계 항목과 상대 프로필이 바뀌면 이전 값과 새 값을 나란히 적는다", () => {
...
test("진행 중인 일의 한 걸음이 이전 값과 함께 붙고 끝난 것은 사실로 옮겼다고 적는다", () => {
