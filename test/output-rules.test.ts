...
const fixtures: {
  ...
  { name: "의문사 질문은 표시만", raw: '{"reply":["다음 주 언제예요"]}', noLaugh: false, want: [], suspect: true },
  ...
  { name: "물음표 붙은 의문사 질문", raw: '{"reply":["다음 주 언제예요?"]}', noLaugh: false, want: [] },
  { name: "웃음 뒤에 숨은 질문", raw: '{"reply":["언제 가나요 ㅎㅎ"]}', noLaugh: false, want: ["묻는 문장에 물음표 없음"] },
  ...
  { name: "좀 있다 또 얘기하자로 미룸", raw: '{"reply":["나도 자료 붙잡고 있어서","좀 있다 또 얘기하자"]}', noLaugh: false, noSendOff: true, want: ["나중에 연락하겠다는 말"] },
  { name: "좀 있다 연락할게도 잡는다", raw: '{"reply":["좀 있다 연락할게","지금은 뭐 해?"]}', noLaugh: false, noSendOff: true, want: ["나중에 연락하겠다는 말"] },
  { name: "먹고 와로 보내면 물음이 붙어도 위반", raw: '{"reply":["맛있게 먹고 와","뭐 먹으러 갔어?"]}', noLaugh: false, noSendOff: true, want: ["자리를 옮기는 상대를 보내는 말"] },
  { name: "잘 다녀와요로 보냄", raw: '{"reply":["잘 다녀와요"]}', noLaugh: false, noSendOff: true, want: ["자리를 옮기는 상대를 보내는 말"] },
  { name: "먹고 왔다는 지난 일은 통과", raw: '{"reply":["나도 아까 국밥 먹고 왔어","너는 뭐 먹어?"]}', noLaugh: false, noSendOff: true, want: [] },
  { name: "먹고 와서 한다는 제 일은 통과", raw: '{"reply":["나도 밥 먹고 와서 마저 할 거야","뭐 먹으러 갔어?"]}', noLaugh: false, noSendOff: true, want: [] },
  { name: "천천히 답해도 된다는 말은 통과", raw: '{"reply":["먹는 동안은 답 천천히 해도 돼","뭐 먹으러 갔어?"]}', noLaugh: false, noSendOff: true, want: [] },
  { name: "자리 옮기는 말 자리가 아니면 안 잡는다", raw: '{"reply":["맛있게 먹고 와"]}', noLaugh: false, want: [] },
