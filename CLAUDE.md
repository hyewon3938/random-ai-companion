...
- [ ] **갓 시작한 대화의 형식 깨짐 재생성 (09-02, 이슈 #257·#259)** — 오늘 메모는 9/6부터 `today_notes`에 쌓이는 것을 확인했다. 갓 시작한 대화에서 형식 깨짐 재생성이 잦아지는지만 남았다(두 턴짜리 평가 케이스에서 객체가 안 오는 회차가 55회 중 1회→7~9회)
