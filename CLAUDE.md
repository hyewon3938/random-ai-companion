...
- [ ] **말투 예시와 상대 자체를 좋아하는 태도 (09-06 머지·배포 전, 이슈 #281·#285, PR #283)** — 목표 말투 예시 13쌍과 상대 자체를 좋아하는 상태·기다렸다는 말·가벼운 질투·대화가 이어지게 닫기를 규칙층에 넣었고(ADR-0012), 캐릭터 정체성 값 4개(대화 성격·애착유형·웃음·호감)도 9/6에 같은 결로 바꿨다. 볼 것: 왜 좋으냐는 물음에 편하다는 말 없이 자기 쪽 이유로 답하는지, 말풍선 끝 어미가 셋 이상 겹치지 않는지, 오·ㅎㅎ가 안 나오는지, 시키는 말로 대화를 닫지 않는지, `llm_calls`의 읽기 방식 분포에서 본문 그대로가 늘지 않는지
- [ ] **자다 깬 시각과 어젯밤 잠 (09-06 머지·배포 전, 이슈 #288·#289, PR #291·#292)** — 자다 깬 답장은 각본과 달라진 기록의 깬 시각을 그대로 쓰고, 피곤한지는 잠든 시각에 6시간을 더한 기준과 기상 시각을 견줘 정한다. 외부 새벽 정리 지시서 패치 둘(docs/woojin-nightly-patch-288·289.md)을 배포 때 손으로 반영한다. 볼 것: 자다 깬 답장이 깬 시각을 어림하지 않는지, 각본 프롬프트에 어젯밤 잠 절이 붙는지, 늦게 자고 늦게 일어난 주말에 피곤한 티가 없는지
- [ ] **연락 텀을 답장 프롬프트에 적기 (09-06 머지·배포 전, 이슈 #284, PR #286)** — 같은 논리일 안에서 캐릭터 마지막 말과 유저 다음 말 사이가 3시간 이상이면 그 텀을 적고, 성격대로 한 마디 티를 내게 한다. 볼 것: 프롬프트에 연락 텀 절이 붙는지, 답장에 그 티가 한 마디로 들어가는지, 각본대로 바빴던 날에 기다렸다는 말이 안 나오는지
