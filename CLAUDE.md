...
- [ ] **연락 텀을 답장 프롬프트에 적기 (09-06 배포, 이슈 #284, PR #286)** — 같은 논리일 안에서 캐릭터 마지막 말과 유저 다음 말 사이가 3시간 이상이면 그 텀을 적고, 성격대로 한 마디 티를 내게 한다. 볼 것: 프롬프트에 연락 텀 절이 붙는지, 답장에 그 티가 한 마디로 들어가는지, 각본대로 바빴던 날에 기다렸다는 말이 안 나오는지
