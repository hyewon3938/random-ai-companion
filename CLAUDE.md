...
- [ ] **답이 끊긴 날에도 낮에 한 통 더 (09-07 머지, 배포 대기, 이슈 #314, PR #315)** — 답이 없는 첫날부터 아침 선톡 네 시간 뒤에 근황 한 통이 나가고, 이틀째는 아침 한 통과 점심 한 통이 나간다. 점심 문안은 새벽이 아니라 팔로업 틱이 그 시각의 각본을 보고 만든다. 볼 것: 어제 대화가 끊긴 날 근황이 아침 선톡보다 먼저 나가지 않는지, 이틀째 12:05~12:50에 점심 한 통이 나가고 그날 근황이 겹치지 않는지, 사흘째부터 조용한지
...
- [ ] **연락 텀과 오랜만에 온 연락 (09-06 배포·09-07 배포 대기, 이슈 #284·#316, PR #286·#317)** — 캐릭터 마지막 말과 유저 다음 말 사이가 3시간 이상이면 그 텀을 적고 성격대로 한 마디 티를 내게 한다. 여섯 시간 넘게 조용하다 낮에 온 연락과 스무 시간 넘게 지나 온 연락은 긴 텀으로 세어 기다렸다는 말을 붙인다. 볼 것: 하루 종일 조용하다 저녁에 말을 걸면 기다렸다는 말이 나오는지, 자고 일어난 아침 인사와 짧은 텀의 바빴던 날에는 안 나오는지, 문장이 매번 같지 않은지, 몇 마디 뒤에 꺼낸 뒤 같은 말을 되풀이하지 않는지
