...
| 10 | 새 구조로 읽은 대화 확인 — 08-29~08-30에 읽기 경로를 바꾼 여덟(#92 규칙층·#117 태그 고르기·#124 태도 이동·#130 하루 경계·#138 JSON 봉투·#139 일기 태그·#140 일정 태그·#144 관계 갱신)을 대화로 확인하고, 인물 데이터를 프롬프트에 얼마나 내보낼지(#102)를 여기서 정한다 | 「배포 순서」 4, 「채점표」 | Fable |
