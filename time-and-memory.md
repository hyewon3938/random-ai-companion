...
**통과선**: 첫 주간 요약의 값을 기준선으로 삼고, 그 뒤 주의 선톡 답 비율과 다시 말한 간격 중앙값이 기준선보다 나빠지지 않으면 통과다. 9/4에 운영 DB를 직접 조회해 센 7일 값은 창이 주간 요약과 같다는 보장이 없어 기준선으로 쓰지 않고, 첫 주간 요약과 나란히 놓고 비교하는 데만 쓴다.
