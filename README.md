...
이 문제를 풀 가치가 있다고 본 근거는 두 가지다. 하나는 유저층의 크기다. AI에게 일상과 감정을 말하는 행동은 특정 취향이 아니라 점점 보편이 되어가고 있다. 다른 하나는 확장성이다. 여기서 검증하는 장치들, 그러니까 같은 시간을 사는 감각과 기억을 먼저 꺼내 건네는 연락은 새 서비스에만 쓰이는 게 아니라 이미 캐릭터와 대화하고 있는 기존 서비스에도 얹을 수 있다. 유저가 캐릭터를 직접 설계하고 이끄는 서비스와 낯선 상대를 만나 알아가는 이 방향은 결이 다르지만, 상대를 사람처럼 느끼게 하는 장치는 양쪽에 다 통한다.
