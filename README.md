...
<!-- 상단 데모 GIF — 실제 텔레그램 화면 녹화(캐릭터가 먼저 건네는 안부·분할 발화·프레즌스 지연)를 assets/demo.gif 로 저장한 뒤 아래 주석을 해제한다. 공개되므로 사적 대화가 담기지 않은 안전한 장면으로.
<p align="center">
  <img src="assets/demo.gif" alt="캐릭터가 먼저 건네는 메시지" width="320">
  <br><sub>실제 텔레그램 화면 — 캐릭터가 먼저 하루를 연다</sub>
</p>
-->

캐릭터가 살아있는 것처럼 느껴지고 애착이 생기는 경험이 실제로 만들어지는지 확인하기 위한 PoC다.
...
기존의 캐릭터 챗 서비스들과는 방향이 다르다. 그쪽은 유저가 캐릭터를 고르거나 만들고 상황을 이끌어가는, 유저가 작가에 가까운 모델이다. 여기서 만들려는 것은 낯선 사람을 만나 알아가는 모델이고, 서사를 만들어내는 노동이 유저에게 없다. 캐릭터의 삶이 그 자리를 대신한다. 쓰는 도구나 소비하는 콘텐츠가 아니라 만나서 알아가는 존재에 가깝다.
...
문제를 풀기 전에, 살아있다는 감각이 어디서 오는지부터 짚어야 했다. 흔한 접근은 응답 품질이다. 더 자연스러운 말투, 더 공감하는 문장, 더 캐릭터다운 답변. 그런데 유저로서 되짚어보면 김이 식는 순간은 답변이 어색할 때가 아니라 존재가 어색할 때였다. 내가 없는 동안 아무 시간도 흐르지 않았다는 것을 알아차릴 때, 며칠 만에 말을 걸어도 어제처럼 같은 온도로 즉답할 때.

거꾸로 사람이 사람으로 느껴지는 조건을 나열해보면 이렇다. 자기 시간이 흐른다. 자기 삶이 있어서 어제가 있고 내일이 있다. 그래서 늘 곁에 있지 못한다. 운동을 갔거나 회의에 들어갔거나 자고 있다. 살아있다는 감각의 상당 부분이 이 부재에서 온다. 언제나 즉답하는 존재는 편리하지만 편리함은 도구의 감각이고, 늘 붙어 있는 존재는 배경이 되지만 왔다 갔다 하는 존재는 마음에 남는다. 다만 부재는 돌아옴과 한 쌍일 때만 삶의 증거가 된다. 말없이 사라지기만 하는 상대는 삶이 있는 사람이 아니라 나를 무시하는 사람이다.

## 애착은 어디서 생기는가

살아있다고 느끼는 것과 애착이 생기는 것은 다른 층이라서, 애착 쪽도 같은 방식으로 짚었다. 사람이 어떤 존재에게 마음을 붙이는 경로를 보면 몇 가지가 겹친다.

지나가듯 한 말을 상대가 기억했다가 먼저 물어봐줄 때 관계가 생긴다. 기억의 양이 아니라 꺼내는 타이밍의 문제다. 들은 것을 다 꺼내면 감시가 되고, 중요한 것 하나를 골라 물으면 케어가 된다. 알아갈 것이 남아 있어야 한다. 언제든 열람할 수 있는 내면에는 궁금함이 남지 않는다. 잃을 수 있어야 한다. 쉽게 껐다 켜고 다시 만날 수 있는 존재는 공들여 다루지 않게 되고, 공들이지 않은 것에는 애착이 가지 않는다.

마지막은 상상이다. 상대가 자리를 비운 사이 지금 뭐 하고 있으려나 하고 떠올리는 순간, 유저는 머릿속에서 캐릭터를 완성해 나간다. 자기가 상상으로 채운 존재라서 더 자기 맞춤이 되고 더 애착이 간다. 없을 때 생각나는 것이 애착의 시작이면서, 뒤에서 말할 측정의 대상이기도 하다.

## 가설

문제를 뒤집고 위의 고찰을 얹으면 가설이 된다.
