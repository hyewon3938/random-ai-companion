...
| 유저와의 관계 | 유저와 어떤 사이인지, 서로 부르는 호칭, 여기까지 쌓인 추억 |
...
올해 무엇에 집중하고 있는지, 이번 계절과 이번 달은 어떤 시기인지, 이번 주는 어떤 주인지를 각각 한 덩어리로 만든다. 날짜별 일정이 아니라 그 기간의 성격이라, 캐릭터가 요즘 어떤 시기를 지나고 있는지가 여기서 나온다.

**2. 한 달치 이벤트**

실제 날짜 위에 며칠에 누구를 만나고 무슨 일이 있는지를 정하고, 날마다의 기력과 기분, 아침에 일어나는 시각을 함께 만든다. 이 값들은 앞뒤 이벤트와 이어지게 만들어서, 회식이 있던 다음 날은 기력이 떨어지고 늦게 일어나는 식으로 하루하루가 서로 맞물린다.

**3. 하루 각본**

캐릭터가 만들어진 그날부터 몇 시에 일어나 무엇을 하고 언제 어디에 있는지를 시간대별로 정한다. 캐릭터는 만들어진 순간부터 오늘 하루를 살고 있는 상태가 된다.
