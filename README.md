...
이 셋 가운데 바탕은 시간이다. 캐릭터의 하루가 먼저 짜여 있고, 답장 속도와 자리 비움, 먼저 거는 말이 모두 그 하루에서 나온다.
...
**문제.** 사람처럼 느껴지려면 캐릭터도 유저와 같은 시간을 살아야 한다. 대화가 없던 사이에도 하루가 흘러 있어야 하고, 지금이 몇 시인지, 오늘 무엇을 하는 날인지 알고 말해야 한다. 유저가 그 하루를 가장 자주 체감하는 지점이 답장 속도다. 처음에 답장 텀을 그냥 랜덤으로 뒀더니 이유 없이 느려지는 게 더 어색했고, 회의 중이라면서 즉답하는 일도 생겼다. 답장이 빠르고 느린 데에는 그날 일정이라는 근거가 있어야 한다.
