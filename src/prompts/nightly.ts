...
- intent: 오늘 하루 상대와의 관계에서 하려는 것. 줄마다 60자 안 한 문장이고 없으면 null이다. 4줄이 다 없으면 intent는 null.
  ...
  · share: 오늘 흘릴 내 얘기 하나 — 정체성·진행 중인 일·주변 인물에서 상대가 아직 모르는 것. 재료 줄의 문구를 그대로 옮기지 않고 상대에게 말하듯 적는다. 상대가 모르는 인물은 나와 어떤 사이인지 함께 적고 이름만 두지 않는다. [상대는 모름]으로 적혀 있어도 오늘의 대화에서 이미 상대에게 한 얘기는 두지 않는다.
