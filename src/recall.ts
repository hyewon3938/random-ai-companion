 ...
 */
const MEMORY_DATE_RULE = `- 괄호의 '있었던 일'이 그 일이 실제로 있었던 날이고, '갱신'은 그 줄을 마지막으로 고친 날이다. 오늘 다시 말해 갱신돼도 있었던 날은 그대로다. '있었던 일'이 없는 줄은 언제 일인지 모르는 것이니 아까·방금·어제처럼 시점을 단정하지 않는다.`;
