...
//
// 유저가 남긴 말이 아직 답을 못 받은 채면 그 말을 짧게 아는 척하고 답은 미루되, 무슨 일로
// 자리를 비우는지는 이 문안에서 반드시 말한다 — 상대 말에만 답하고 끝나면 예고가 사라진다.
//
  ...
  return [
    ...
    ...(pending
      ? [
          ...
          `답을 미루더라도 무슨 일로 자리를 비우는지는 반드시 남긴다. 상대 말에만 답하고 끝내면 이 문안은 제 몫을 못 한다.`,
        ]
      : []),
    ``,
