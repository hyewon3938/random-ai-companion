...
// 선톡을 접는다). 발송 함수는 setPendingSender로 pending.ts에 넘겨 준다 — 순환 참조를
...
// 직접 가져오면 두 파일이 서로를 참조하는 순환이 생겨서 주입 쪽을 택했다.
...
import { ARRIVAL_WAIT_MAX_MS, ARRIVAL_WAIT_MIN_MS } from "./thresholds.js";
import {
  getActiveCharacter,
  getActiveCharacters,
  getDayPlan,
