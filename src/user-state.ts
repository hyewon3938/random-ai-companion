...
// 캐릭터의 근황을 물었는지, 호감을 말했는지, 직전에 캐릭터가 쓴 플러팅을 어떻게 받았는지. 이 넷은
...
- move_reaction: [직전에 캐릭터가 쓴 플러팅]에 적힌 플러팅을 상대가 어떻게 받았는지. 그 플러팅은 [최근 대화]에서 캐릭터(플러팅: 이름)으로 표시한 말이다. 둘 이상이면 가장 나중 것에 대한 반응을 적는다.
