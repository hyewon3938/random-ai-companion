...
| presence.ts | 긴 일정에 들어가기 직전 예고 선톡 | 10분 간격 | 문안 생성 |
...
다녀온 뒤에 보내는 복귀 인사도 선톡이지만 답장 경로의 bot.ts에 있다. 답장 불가 구간이 끝나는 시각에 깨어나는 자리를 한 곳으로 두어야, 그 사이 쌓인 메시지에 몰아 답할지 복귀 인사를 보낼지를 한 번에 가릴 수 있기 때문이다. 하루에 보내는 선톡 총량은 이 인사까지 함께 센다.
